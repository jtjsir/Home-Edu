...
function setCookie(e, n) {
    ...
    document.cookie = e + "=" + escape(n) + ";expires=" + o.toGMTString()
}
function GoEasy(e) {
    if (this._isEmpty(e.appkey)) return void("undefined" != typeof e.onConnectFailed && e.onConnectFailed({
        code: 400,
        content: "appkey is required"
    }));
    this._copyConfig(e);
    var n = this._subServerHost.replace("://", "://" + goEasyDomainNumber.number()),
    t = n + ":" + this._subServerPort;
...
GoEasyDomainNumber.prototype = {
    ...
    initialCurrentNumber: function() {
        return currentNumber = parseInt(getCookie("goeasyNode")),
        currentNumber > 0 && currentNumber < this.maxNumber ? currentNumber += 1 : currentNumber = 1,
...
GoEasy.prototype = {
    ...
    channels: [],
    _subServerHost: "https://www.goeasy.io",
    _subServerPort: 9e3,
    ...
    _copyConfig: function(e) {
        ...
        this._isEmpty(e.userId) ? (this._userId = "anonymous-" + Math.floor(1e5 * Math.random() + 1), e.userId = this._userId) : this._userId = this._trim(e.userId),
        this._isEmpty(e.username) ? (this._username = "", e.username = "") : this._username = this._trim(e.username),
        1 == e.debug && (this.debug = !0)
    },
    subscribe: function(e) {
        if (this._isEmpty(e.channel)) return this.log("'channel' is required."),
        void("undefined" != typeof e.onFailed && e.onFailed({
            code: 400,
            content: "channel is required"
        }));
        this.subscribeBuffer[e.channel] = e;
        var n = this;
        null != n.authorizeResult && "connected" == n.networkStatus && (e.checking = !0, n.doSubscribeAndCheckAck(e))
    },
    doSubscribe: function(e) {
        var n = this;
        200 == n.authorizeResult.code && n.socket.emit("subscribe", {
            sid: n.authorizeResult.sid,
            channel: e.channel
        },
        function(t) {
            1 != e.finish && (e.finish = !0, delete n.subscribeBuffer[e.channel], 200 == t.resultCode ? (n.channels[e.channel] = e, "undefined" != typeof e.onSuccess && e.onSuccess()) : "undefined" != typeof e.onFailed && e.onFailed({
                code: t.resultCode,
                content: t.content
            }))
        })
    ...
    doSubscribeAndCheckAck: function(e) {
        ...
        var t = window.setInterval(function() {
            e.finish || "connected" != n.networkStatus ? (e.checking = !1, window.clearInterval(t)) : n.doSubscribe(e)
        },
        1e3)
    },
    unsubscribe: function(e) {
        function n() {
            ...
            function(n) {
                i = !0,
                200 == n.resultCode ? (delete o.channels[e.channel], "undefined" != typeof e.onSuccess && e.onSuccess()) : "undefined" != typeof e.onFailed && e.onFailed({
                    code: n.resultCode,
                    content: n.content
                })
            }) : (i = !0, "undefined" != typeof e.onFailed && e.onFailed({
        ...
        function t() {
            n();
            var t = window.setInterval(function() { ! i && "connected" == o.networkStatus && 0 > r ? (r++, n()) : r == o.maxRetries ? (window.clearInterval(t), "undefined" != typeof e.onFailed && e.onFailed({
                    code: 408,
        ...
        if ("undefined" == typeof this.channels[e.channel]) return this.log("'channel' is not subscribed."),
        void("undefined" != typeof e.onFailed && e.onFailed({
            code: 400,
        ...
        i = !1,
        r = 0;
        if (null != this.authorizeResult && "connected" == o.networkStatus) t();
        else var s = window.setInterval(function() {
            null != o.authorizeResult && "connected" == o.networkStatus ? (window.clearInterval(s), t()) : (r++, r == o.maxRetries && (window.clearInterval(s), "undefined" != typeof e.onFailed && e.onFailed({
                code: 408,
                content: "Server unreachable or timeout"
            })))
        },
    ...
    publish: function(e) {
        function n(n) {
            ...
            function(n) {
                i = !0,
                200 == n.resultCode ? "undefined" != typeof e.onSuccess && e.onSuccess() : "undefined" != typeof e.onFailed && e.onFailed({
                    code: n.resultCode,
                    content: n.content
                })
            }) : (i = !0, "undefined" != typeof e.onFailed && e.onFailed({
        ...
        function t() {
            var t = o.uuid();
            n(t);
            var s = window.setInterval(function() { ! i && r < o.maxRetries ? (r++, n(t)) : r == o.maxRetries ? (window.clearInterval(s), "undefined" != typeof e.onFailed && e.onFailed({
                    code: 408,
                    content: "Server unreachable or timeout"
        ...
        if (this._isEmpty(e.message)) return this.log("'message' is required."),
        void("undefined" != typeof e.onFailed && e.onFailed({
            code: 400,
    ...
    _callbackEvents: function(e) {
        ...
        function(e, t) {
            t && t(e);
            var o = e.channel;
            "undefined" != typeof n.channels[o].onMessage && n.channels[o].onMessage(e)
        }),
        this.socket.on("connect",
        function() {
            function t() {
                n.socket.emit("authorize", o,
                function(t) {
                    if (!i) if (i = !0, null == n.authorizeResult && (n.authorizeResult = {}), n.authorizeResult.code = t.resultCode, n.authorizeResult.content = t.content, 200 == t.resultCode) {
                        if (n.authorizeResult.sid != t.sid) {
                            n.authorizeResult.sid = t.sid;
                            for (var o in n.channels) n.doSubscribeAndCheckAck(n.channels[o])
                        } else n.authorizeResult.sid = t.sid;
                        for (var r in n.subscribeBuffer) n.doSubscribeAndCheckAck(n.subscribeBuffer[r]);
                        "undefined" != typeof e.onConnected && e.onConnected()
                    } else "undefined" != typeof e.onConnectFailed && e.onConnectFailed({
                        code: t.resultCode,
                        content: t.content
                    })
                })
            ...
            null != n.authorizeResult && (o.sid = n.authorizeResult.sid);
            var i = !1;
            t();
            var r = window.setInterval(function() {
                i || "connected" != n.networkStatus ? window.clearInterval(r) : t()
            },
            1e3)
        },
        this.socket.on("connect_error",
        function(n) {
            "undefined" != typeof e.onConnectFailed && e.onConnectFailed({
                code: 408,
                content: n
            })
        })),
        ...
        function() {
            ...
            "undefined" != typeof e.onDisconnected && e.onDisconnected()
        })
    },
    _isEmpty: function(e) {
        return "undefined" == typeof e || null == e || 0 == this._trim(e).length
    },
    _trim: function(e) {
        return e.replace(/(^\s*)|(\s*$)/g, "")
    },
    log: function(e) {
        window.console && this.debug && console.log(e)
    },
    uuid: function(e, n) {
        var t, o = "0123456789abcdefghijklmnopqrstuvwxyz".split(""),
        i = o,
        r = [];
        if (n = n || i.length, e) for (t = 0; e > t; t++) r[t] = i[0 | Math.random() * n];
        else {
            var s;
            for (r[8] = r[13] = r[18] = r[23] = "-", r[14] = "4", t = 0; 36 > t; t++) r[t] || (s = 0 | 16 * Math.random(), r[t] = i[19 == t ? 3 & s | 8 : s])
        }
        return r.join("")
    }
}; !
    ...
    return function e(t, n, r) {
        ...
        2 : [function(t, e, n) {
            function r(t, e) {
                ...
                i = r.source,
                p = r.id;
                return e.forceNew || e["force new connection"] || !1 === e.multiplex ? (a("ignoring socket cache for %s", i), n = s(i, e)) : (c[p] || (a("new io instance for %s", i), c[p] = s(i, e)), n = c[p]),
                n.socket(r.path)
            }
            var o = t("./url"),
        ...
        3 : [function(t, e, n) {
            function r(t, e) {
                return this instanceof r ? (t && "object" == typeof t && (e = t, t = void 0), e = e || {},
                e.path = e.path || "/socket.io", this.nsps = {},
                this.subs = [], this.opts = e, this.reconnection(e.reconnection !== !1), this.reconnectionAttempts(e.reconnectionAttempts || 1 / 0), this.reconnectionDelay(e.reconnectionDelay || 1e3), this.reconnectionDelayMax(e.reconnectionDelayMax || 5e3), this.randomizationFactor(e.randomizationFactor || .5), this.backoff = new h({
                    min: this.reconnectionDelay(),
                    max: this.reconnectionDelayMax(),
                    jitter: this.randomizationFactor()
                }), this.timeout(null == e.timeout ? 2e4: e.timeout), this.readyState = "closed", this.uri = t, this.connected = [], this.encoding = !1, this.packetBuffer = [], this.encoder = new a.Encoder, this.decoder = new a.Decoder, this.autoConnect = e.autoConnect !== !1, void(this.autoConnect && this.open())) : new r(t, e)
            }
            ...
            r.prototype.socket = function(t) {
                ...
                if (!e) {
                    ...
                    function() {
                        e.id = n.engine.id,
                        ~f(n.connected, e) || n.connected.push(e)
                    })
                }
                return e
            },
            r.prototype.destroy = function(t) {
                var e = f(this.connected, t);~e && this.connected.splice(e, 1),
        ...
        5 : [function(t, e, n) {
            ...
            r.prototype.emit = function(t) {
                ...
                return "function" == typeof e[e.length - 1] && (p("emitting packet with ack id %d", this.ids), this.acks[this.ids] = e.pop(), r.id = this.ids++),
        ...
        6 : [function(t, e, n) { (function(n) {
                function r(t, e) {
                    var r = t,
                    e = e || n.location;
                    return null == t && (t = e.protocol + "//" + e.host),
                    "string" == typeof t && ("/" == t.charAt(0) && (t = "/" == t.charAt(1) ? e.protocol + t: e.hostname + t), /^(https?|wss?):\/\//.test(t) || (i("protocol-less url %s", t), t = "undefined" != typeof e ? e.protocol + "//" + t: "https://" + t), i("parse %s", t), r = o(t)),
        ...
        10 : [function(t, e, n) {
            ...
            r.enable = function(t) {
                ...
                for (var n = (t || "").split(/[\s,]+/), o = n.length, i = 0; o > i; i++) t = n[i].replace("*", ".*?"),
            ...
            r.enabled = function(t) {
                for (var e = 0,
                n = r.skips.length; n > e; e++) if (r.skips[e].test(t)) return ! 1;
                for (var e = 0,
                n = r.names.length; n > e; e++) if (r.names[e].test(t)) return ! 0;
                return ! 1
            };
            try {
        ...
        13 : [function(t, e, n) { (function(n) {
                function r(t, e) {
                    if (! (this instanceof r)) return new r(t, e);
                    if (e = e || {},
                    t && "object" == typeof t && (e = t, t = null), t && (t = u(t), e.host = t.host, e.secure = "https" == t.protocol || "wss" == t.protocol, e.port = t.port, t.query && (e.query = t.query)), this.secure = null != e.secure ? e.secure: n.location && "https:" == location.protocol, e.host) {
                        var o = e.host.split(":");
                        e.hostname = o.shift(),
        ...
        19 : [function(t, e, n) {
            ...
            r.prototype.write = function(t) {
                ...
                this.writable = !1;
                for (var r = 0,
                o = t.length; o > r; r++) i.encodePacket(t[r], this.supportsBinary,
                function(t) {
                    try {
                        n.ws.send(t)
                    } catch(e) {
        ...
        24 : [function(t, e, n) {
            ...
            e.exports = function(t, e) {
                return e = e || {},
                "string" == typeof t ? r(t) : e["long"] ? i(t) : o(t)
            }
        },
        {}],
        25 : [function(t, e, n) { (function(e) {
                function r(t, e) {
        ...
        27 : [function(t, e, n) {
            function r(t, e, n) {
                function r(t, o) {
                    if (r.count <= 0) throw new Error("after called too many times"); --r.count,
        ...
        31 : [function(e, n, r) { (function(e) { !
                function(o) {
                    ...
                    g = "object" == typeof e && e; (g.global === g || g.window === g) && (o = g);
        ...
        34 : [function(t, e, n) {
            ...
            e.exports = function(t) {
                ...
                for (var s = r.exec(t || ""), a = {},
                c = 14; c--;) a[o[c]] = s[c] || "";
                return - 1 != n && -1 != i && (a.source = e, a.host = a.host.substring(1, a.host.length - 1).replace(/;/g, ":"), a.authority = a.authority.replace("[", "").replace("]", "").replace(/;/g, ":"), a.ipv6uri = !0),
                a
            }
        },
        {}],
        ...
        42 : [function(t, e, n) {
            ...
            o = ["source", "protocol", "authority", "userInfo", "user", "password", "host", "port", "relative", "path", "directory", "file", "query", "anchor"];
            e.exports = function(t) {
                for (var e = r.exec(t || ""), n = {},
                i = 14; i--;) n[o[i]] = e[i] || "";
                return n
            }
        },
        {}],
        43 : [function(t, e, n) { (function(e) {
                var r = t("isarray"),
                o = t("./is-buffer");
                ...
                if (!n("json")) {
                    ...
                    if (i = function(t, e) {
                        ...
                        function(t, e) {
                            ...
                            for (n in t) i && "prototype" == n || !o.call(t, n) || (r = "constructor" === n) || e(n); (r || o.call(t, n = "constructor")) && e(n)
                    ...
                    !n("json-stringify")) {
                        ...
                        _ = function(t, e, n, r, c, p, u) {
                            ...
                            if ("object" == typeof f && f) if (h = a.call(f), h != d || o.call(f, "toJSON"))"function" == typeof f.toJSON && (h != y && h != g && h != m || o.call(f, "toJSON")) && (f = f.toJSON(t));
                            else if (f > -1 / 0 && 1 / 0 > f) {
                                if (x) {
                            ...
                            if ("object" == typeof f) {
                                ...
                                if (u.push(f), P = [], U = p, p += c, h == m) {
                                    for (N = 0, O = f.length; O > N; N++) R = _(N, f, n, r, c, p, u),
                                    P.push(R === s ? "null": R);
                                    q = P.length ? c ? "[\n" + p + P.join(",\n" + p) + "\n" + U + "]": "[" + P.join(",") + "]": "[]"
                                } else i(r || f,
                                function(t) {
                        ...
                        u.stringify = function(t, e, n) {
                            ...
                            if ("function" == typeof e || "object" == typeof e && e) if ((s = a.call(e)) == l) o = e;
                                ...
                                i = {};
                                for (var c, p = 0,
                                u = e.length; u > p; c = e[p++], s = a.call(c), (s == g || s == y) && (i[c] = 1));
                            }
                    ...
                    if (!n("json-parse")) {
                        ...
                        q = function() {
                            for (var t, e, n, r, o, i = R,
                            s = i.length; s > P;) switch (o = i.charCodeAt(P)) {
                            case 9:
                            case 10:
                            case 13:
                            case 32:
                            ...
                            case 44:
                                ...
                                t;
                            case 34:
                                for (t = "@", P++; s > P;) if (o = i.charCodeAt(P), 32 > o) U();
                                ...
                                case 114:
                                    ...
                                    break;
                                case 117:
                                    for (e = ++P, n = P + 4; n > P; P++) o = i.charCodeAt(P),
                            ...
                            default:
                                ...
                                if (r && U(), "true" == i.slice(P, P + 4)) return P += 4,
                                !0;
                                if ("false" == i.slice(P, P + 5)) return P += 5,
                                !1;
                                if ("null" == i.slice(P, P + 4)) return P += 4,
                                null;
                                U()
                            }
                            return "$"
                        ...
                        D = function(t) {
                            ...
                            if ("$" == t && U(), "string" == typeof t) {
                                ...
                                if ("[" == t) {
                                    for (e = []; t = q(), "]" != t; n || (n = !0)) n && ("," == t ? (t = q(), "]" == t && U()) : U()),
                                    "," == t && U(),
                                    e.push(D(t));
                                    return e
                                }
                                if ("{" == t) {
                                    for (e = {}; t = q(), "}" != t; n || (n = !0)) n && ("," == t ? (t = q(), "}" == t && U()) : U()),
                                    ("," == t || "string" != typeof t || "@" != (b ? t.charAt(0) : t[0]) || ":" != q()) && U(),
                                    e[t.slice(1)] = D(q());
                                    return e
                                }
                                U()
